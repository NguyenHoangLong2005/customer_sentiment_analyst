...
# 1. SETUP
# ══════════════════════════════════════════════════════════════
cells.append(md(["## 1. Khởi tạo môi trường"]))
...
# 2. HYPERPARAMETERS
# ══════════════════════════════════════════════════════════════
cells.append(md(["## 2. Siêu tham số"]))
...
# 5. HELPER FUNCTIONS
# ══════════════════════════════════════════════════════════════
cells.append(md(["## 5. Các hàm hỗ trợ"]))
...
# ══════════════════════════════════════════════════════════════
cells.append(md(["## 7. Biểu đồ quá trình huấn luyện (Best Fold)"]))
...
# ══════════════════════════════════════════════════════════════
cells.append(md(["## 8. Đánh giá trên tập Test"]))
...
# 10. INFERENCE DEMO
# ══════════════════════════════════════════════════════════════
cells.append(md(["## 10. Demo Inference"]))
...
notebook = {
    "cells": cells,
    "metadata": {
        "colab"      : {"name": "02_PhoBERT.ipynb", "provenance": []},
...
with open(r'c:\userdata\sentiment_analyst\notebooks\02_PhoBERT.ipynb', 'w', encoding='utf-8') as f:
